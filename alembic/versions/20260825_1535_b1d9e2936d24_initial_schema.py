...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_trial_grants_identity_hash"), "trial_grants", ["identity_hash"], unique=True
    )
    op.create_table(
        "users",
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["owner_id"],
            ["users.id"],
            name=op.f("fk_plan_groups_owner_id_users"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_plan_groups")),
    )
    op.create_index(
        op.f("ix_plan_groups_invite_code"), "plan_groups", ["invite_code"], unique=True
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["user_id"],
            ["users.id"],
            name=op.f("fk_study_days_user_id_users"),
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.Column("deleted_at", sa.DateTime(timezone=True), nullable=True),
        sa.ForeignKeyConstraint(
            ["user_id"], ["users.id"], name=op.f("fk_units_user_id_users"), ondelete="CASCADE"
        ),
    ...
    op.create_table(
        ...
        sa.Column("deleted_at", sa.DateTime(timezone=True), nullable=True),
        sa.ForeignKeyConstraint(
            ["unit_id"], ["units.id"], name=op.f("fk_chats_unit_id_units"), ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["unit_id"],
            ["units.id"],
            name=op.f("fk_class_sessions_unit_id_units"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["user_id"],
            ["users.id"],
            name=op.f("fk_class_sessions_user_id_users"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_class_sessions")),
    )
    op.create_index(
        op.f("ix_class_sessions_deleted_at"), "class_sessions", ["deleted_at"], unique=False
    )
    op.create_index(
        op.f("ix_class_sessions_unit_id"), "class_sessions", ["unit_id"], unique=False
    )
    op.create_index(
        op.f("ix_class_sessions_user_id"), "class_sessions", ["user_id"], unique=False
    )
    op.create_index(
        "ix_class_sessions_user_weekday", "class_sessions", ["user_id", "weekday"], unique=False
    )
    op.create_table(
        "events",
        sa.Column("user_id", sa.Uuid(), nullable=False),
        ...
        sa.Column("deleted_at", sa.DateTime(timezone=True), nullable=True),
        sa.ForeignKeyConstraint(
            ["unit_id"], ["units.id"], name=op.f("fk_events_unit_id_units"), ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["unit_id"],
            ["units.id"],
            name=op.f("fk_materials_unit_id_units"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["user_id"],
            ["users.id"],
            name=op.f("fk_materials_user_id_users"),
            ondelete="CASCADE",
        ),
    ...
    op.create_index(
        "ix_materials_extraction",
        "materials",
        ["extraction_status", "created_at"],
        unique=False,
    )
    op.create_index(
        "ix_materials_unit_archived", "materials", ["unit_id", "archived"], unique=False
    )
    ...
    op.create_index(
        "ix_materials_user_updated", "materials", ["user_id", "updated_at"], unique=False
    )
    op.create_table(
        "plan_group_members",
        ...
        sa.ForeignKeyConstraint(
            ["group_id"],
            ["plan_groups.id"],
            name=op.f("fk_plan_group_members_group_id_plan_groups"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["user_id"],
            ["users.id"],
            name=op.f("fk_plan_group_members_user_id_users"),
            ondelete="CASCADE",
        ),
    ...
    op.create_index(
        op.f("ix_plan_group_members_group_id"), "plan_group_members", ["group_id"], unique=False
    )
    op.create_index(
        op.f("ix_plan_group_members_user_id"), "plan_group_members", ["user_id"], unique=False
    )
    op.create_table(
        "subscriptions",
        sa.Column("user_id", sa.Uuid(), nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ["group_id"],
            ["plan_groups.id"],
            name=op.f("fk_subscriptions_group_id_plan_groups"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["user_id"],
    ...
    op.create_index(
        op.f("ix_subscriptions_group_id"), "subscriptions", ["group_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["material_id"],
            ["materials.id"],
            name=op.f("fk_material_chunks_material_id_materials"),
            ondelete="CASCADE",
        ),
    ...
    op.create_index(
        "ix_material_chunks_material_ordinal",
        "material_chunks",
        ["material_id", "ordinal"],
        unique=False,
    )
    op.create_index(
        op.f("ix_material_chunks_user_id"), "material_chunks", ["user_id"], unique=False
    )
    op.create_table(
        "messages",
